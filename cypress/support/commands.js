...
Cypress.Commands.add('buscaPorTemas', () => {
  ...
  cy.get('[label="Tema"] > .v-input__control > .v-input__slot > .v-select__slot > :nth-child(4)', { timeout: 10000 })
    .click()
...
Cypress.Commands.add('buscaPorArea', () => {
  ...
  cy.get('.v-select__selections', { timeout: 10000 })
    .should('be.visible')
    .click()
  ...
  cy.get('[return-object=""] > .v-input__control > .v-input__slot > .v-select__slot > :nth-child(4)', { timeout: 10000 })
  .should('be.visible')
...
Cypress.Commands.add('buscaPorEspecialidades', () => {
  ...
  cy.get('[label="Especialidade"] > .v-input__control > .v-input__slot > .v-select__slot > :nth-child(4)', { timeout: 10000 })
    .click()

  cy.get('div:contains(Psicologia Clínica)')
    .click({ multiple: true, force: true })

  cy.get('span:contains( Procurar )', { timeout: 10000 })
    .should('be.visible')
